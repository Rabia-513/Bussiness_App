...
class _HealthScreenState extends State<HealthScreen> {
  ...
  List<String> locations = ['All', 'Rawalpindi', 'Isalamabad', 'Lahore'];

  Stream<QuerySnapshot> _getBusinesses() {
    CollectionReference businessesRef = _firestore.collection('businesses');
    Query query = businessesRef.where('category', isEqualTo: 'Healthcare');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Healthcare Businesses'),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AddBusinessScreen(category: 'Healthcare'),
            ),
          );
        },
  ...
  Widget buildResults(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore.collection('businesses')
          .where('category', isEqualTo: 'Healthcare')
